...
input_data_path = paste0('/work/home/zhangp/mission/09_deep_sumamry/data_big_panel/CNV/',cancer,'.txt')
...
for (one_sample_id in sample_id){
	...
	write_table_path <- paste0('/work/home/zhangp/mission/12_CNV_deep_sumamry/split_data/panel_data_test/',cancer,'/',one_sample_id,'.txt')
