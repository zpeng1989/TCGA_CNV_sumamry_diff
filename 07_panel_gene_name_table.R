...
input_data_path = paste0('/work/home/zhangp/mission/12_CNV_deep_sumamry/split_data/panel_data_test/',cancer,'/')
...
for(one_input_data in all_input_data){
	...
	new_data_path = paste0('/work/home/zhangp/mission/12_CNV_deep_sumamry/split_data/panel_data/',cancer,'/',one_input_data)
